package prj.sonicunleashed.assets 
{
	...
	public class BridgeAsset extends AbstractMapAsset implements IMapAsset 
	{
		public static const BRIDGE_BITMAP_CLASS_NAME:String	= 'LibAssetBridgeBitmap';
		
		private var ourBitmap:Bitmap;
		
		public function BridgeAsset(myWorld:IWorld, myViewport:IMapAssetViewport, myX:Number=0, myY:Number=0, myRotation:Number=0) {
			super();
			ourWorld = myWorld;
			
			var myBitmapClass:Class			= getDefinitionByName(BRIDGE_BITMAP_CLASS_NAME) as Class; 
			var myBMPData:BitmapData		= new myBitmapClass(1024, 256) as BitmapData;
