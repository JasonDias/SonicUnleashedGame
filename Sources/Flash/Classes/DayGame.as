package  
{
	...
	public class DayGame extends AbstractGame implements IGame
	{
		private static const GAME_NAME:String = 'day';
		...
		public function init():void{
			...
			var myTileBmp:BitmapData		= new myGoundBitmapClass(175, 106) as BitmapData;
...
//			ourAssetIndexMap[EnemyBigBossFactory]						= {className:EnemyBigBossFactory, value:13};
			...
			var myUpAction:IPersistantAction						= ActionsFacade.getInstance().addAction(PlayerCharacterActions.JUMP_ACTION, myHero);
			...
			var mySpacebarAction:IPersistantAction					= ActionsFacade.getInstance().addAction(SonicActions.SUPER_RUN_ACTION, myHero);
			var mySpaceKeyConnector:KeyToPersistantActionConnector	= new KeyToPersistantActionConnector(this.stage, Keyboard.SPACE, mySpacebarAction);
