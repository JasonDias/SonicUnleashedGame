package prj.sonicunleashed.assets.factories {
	...
	import prj.sonicunleashed.assets.HorizontalSpikesAsset;	
	...
	public class HorizontalSpikeFactory extends AbstractMapAssetFactory implements IMapAssetFactory {
		public function createMapAsset(myWorld:IWorld, myViewport:IMapAssetViewport, myDisplayObject:DisplayObject, myX:Number=0, myY:Number=0, myRotation:Number=0):IMapAsset {
			var myAsset:IMapAsset		= new HorizontalSpikesAsset(myWorld, myViewport, myX, myY, myRotation);				
