package prj.sonicunleashed.assets 
{
	...
	public class StairsAsset extends AbstractMapAsset implements IMapAsset
	{
		public static const STAIRS_BITMAP_CLASS_NAME:String	= 'LibAssetStairsBitmap';
		
		private var ourBitmap:Bitmap;
		
		public function StairsAsset(myWorld:IWorld, myViewport:IMapAssetViewport, myX:Number=0, myY:Number=0, myRotation:Number=0) {
			super();
			ourWorld = myWorld;
			
			var myStairsBitmapClass:Class	= getDefinitionByName(StairsAsset.STAIRS_BITMAP_CLASS_NAME) as Class; 
			var myBMPData:BitmapData		= new myStairsBitmapClass(768, 128) as BitmapData;
		...
		public function createBody(myWorld:IWorld, myX:Number = 0, myY:Number = 0, myRotation:Number = 0):void {
			...
			myShapeDef.vertices[1].Set(-hx+myWorldUnits.getMetersFromPixels(486), -hy);
			...
			ourBody.SetXForm(new b2Vec2(myX + hx, myY - myWorldUnits.getMetersFromPixels(32)), myRotation);
