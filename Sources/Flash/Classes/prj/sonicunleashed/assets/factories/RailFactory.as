...
{
	import prj.sonicunleashed.assets.RailAsset;
	...
	public class RailFactory extends AbstractMapAssetFactory implements IMapAssetFactory 
	{
		public function createMapAsset(myWorld:IWorld, myViewport:IMapAssetViewport, myDisplayObject:DisplayObject, myX:Number = 0, myY:Number = 0, myRotation:Number = 0):IMapAsset {
			var myAsset:IMapAsset		= new RailAsset(myWorld, myViewport, myX, myY, myRotation);
