package prj.sonicunleashed.assets 
{
	...
	public class VerticalSpikesAsset extends AbstractSpikeAsset implements IMapAsset, ICollidable 
	{	
		public static const LIB_ASSET_CLASS_NAME:String					= 'LibAssetSpikesVerticalBitmap';
		
		public function VerticalSpikesAsset(myWorld:IWorld, myViewport:IMapAssetViewport, myX:Number=0, myY:Number=0, myRotation:Number=0)
		{
		...
		override protected function init(myWorld:IWorld, myViewport:IMapAssetViewport, myX:Number=0, myY:Number=0, myRotation:Number=0):void{			
			var myAssetClass:Class	= getDefinitionByName(VerticalSpikesAsset.LIB_ASSET_CLASS_NAME) as Class;
		...
		public function createBody(myWorld:IWorld, myX:Number=0, myY:Number=0, myRotation:Number=0):void {
			...
			myShapeDef.vertices[0].Set(-hx+myWorldUnits.getMetersFromPixels(9), -hy+myWorldUnits.getMetersFromPixels(10));
			myShapeDef.vertices[1].Set(hx-myWorldUnits.getMetersFromPixels(9), -hy+myWorldUnits.getMetersFromPixels(10));
			...
			myShapeDef						= new b2PolygonDef();
			myShapeDef.vertexCount			= 4;
			myShapeDef.vertices[0].Set(-hx+myWorldUnits.getMetersFromPixels(10), -hy);
			myShapeDef.vertices[1].Set(hx-myWorldUnits.getMetersFromPixels(10), -hy);
			myShapeDef.vertices[2].Set(hx-myWorldUnits.getMetersFromPixels(10),  -hy+myWorldUnits.getMetersFromPixels(10));
